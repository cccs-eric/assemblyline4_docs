...
# Alert
> You can use these schemas to help craft Lucene search queries.  Alert document model available from the Alert index.  Fields listed in this table can be used when searching information related to files and are available to Lucene.
