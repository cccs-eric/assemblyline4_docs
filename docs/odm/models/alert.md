...
# Alert
> The Alert model encapsulates all the relevant information generated when Assemblyline identifies a potential threat within a submitted file.  This model is available from the Alert index and is used for crafting Lucene search queries. Fields in this table correspond to attributes in the Alert object that can be queried and are integral to understanding the alert state and its related analysis results.
