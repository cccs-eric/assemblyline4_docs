...
# File
> File document model available from the File index.  Fields listed in this table can be used when searching information related to files and are available to Lucene.
